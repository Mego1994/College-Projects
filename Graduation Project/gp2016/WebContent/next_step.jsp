...
<div id="tooplate_main">
 <div id="tooplate_menu">
    ...
    <h3 style="margin:50px 0 0 1000px;">Welcome, <a style="text-decoration: underline;" href="#"><strong><%=session.getAttribute("patientUsername") %></strong></a></h3>
        ...
        <div class="col_w270 float_l">
	        ...
	        <!--Barcode form-->
				<form target='_blank' action="barcodeCheck.jsp" method="post">
                          <br>
                          Sample code <input type="text" name="datatoencode" value= <%=barCode%>/>
                          <input id="barcode_submit" onclick="open" type="submit" name="barcode" value="Generate Barcode"/>
                          </form>
	        
    		  <form method="post" name="sample" id="sample" action="profile.jsp">	
