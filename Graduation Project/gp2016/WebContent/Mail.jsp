...
<title>Complete Care Lab | Mail Sent</title> 
...
<body> 
  ...
  <div id="tooplate_main"> 
    ...
    <%
    	//get string value after '?' in URL.
    	String message = request.getQueryString();
		String caseWordRemoved = message.substring(5);
		String messageModifiedReplaced = caseWordRemoved.replace(".", " ");
    %>
    
    <div id="tooplate_content">
    
        <h1><%out.print(messageModifiedReplaced);%>
        </h1>
    	
		<div class="cleaner_h30 horizon_divider"></div>
        <div class="cleaner_h30"></div>
        
        <p style="color: red;">This page will be closed in <span id="spntime"></span> seconds....</p>
