...
<title>Complete Care Lab | Manage Doctor </title> 
        ...
        <div class="col_w270 float_l">
            ...
            <!-- Profile table -->
        		<br><br>    <h3>All Doctors</h3>
            			...
            			<div style= "border: 1px solid #fff;">Username</div>
          				<div style= "border: 1px solid #fff;"><input id="searchUsername" style="width: 150px; margin-left: 100px;" type="text" placeholder="Search by Username"></div>
          				</th>
            ...
            <br></br><br></br>
				...
				<h5> Fields colored by <strong style="color: red;">RED</strong> are mandatory</h5>                          
				    <!--START OF FORM -->
					<form method="post" id="signupform" name="signupform" action="NewDoctorActions.jsp">
			        <!--START Of TABLE -->		    
			            <table id="dr" border="0" cellspacing="0" style="width: 550px; margin-left:-70px;" >
                           <tbody>
                         	
                         	<tr>
                         	<td ><input type='radio' id='insert' name='action' value='insert' checked/>ADD</input></td><td ><input type='radio' id='update' name='action' value='update'/>UPDATE<br><strong>&nbsp;&nbsp;By Username.</strong></input></td><td></td><td><input type='radio' id='view' name='action' value='view'/>VIEW<br><strong>&nbsp;&nbsp;By First & Last name or Username.</strong></input></td><td><input type='radio' id='delete' name='action' value='delete'/>DELETE<br><strong>&nbsp;&nbsp;By Username.</strong></input></td></td><td><input type='radio' id='active' name='action' value='active'/>Set to active user.<br><strong>&nbsp;&nbsp;Type username.</strong></input></td>
                         	</tr>			
...
<div id="tooplate_footer_wrapper">
 ...
 $('#userGen').click(function(){		//assign the random number to password text box.
	 ...
	 $('#username').val("doc" + fname + "" + lname + phone);
 });
