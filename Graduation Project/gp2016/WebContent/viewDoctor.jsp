...
<title>Complete Care Lab | View Doctor</title> 
...
<!--       					</thead> -->
        				...
        				ResultSet rs=statement.executeQuery("select * from doctor1 where username = '"+session.getAttribute("docUsername")+"' or fname = '"+session.getAttribute("fname")+"' and lname = '"+session.getAttribute("lname")+"'");
