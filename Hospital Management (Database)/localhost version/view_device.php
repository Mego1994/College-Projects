...
<h2><a id="show" style="text-decoration:underline" onclick="open" href="data_tables.php">Show data tables before search.</h2></a>
    ...
    <script>
        ...
        <h2>Search By Device Serial Number</h2>
	<h3>
    	<form action = "view_action_device.php" method = "POST">
Device Serial Number: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input type = "number" maxlength = "10" name ="device_serial_number" >
	
	<h4>&nbsp;</h4>
	  <button type = "submit"><h3>Search</button>
    </p>
    <p>&nbsp;</p>
    	</form>
	</h3>
